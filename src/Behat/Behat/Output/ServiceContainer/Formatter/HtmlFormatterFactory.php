...
class HtmlFormatterFactory implements FormatterFactory
{
    ...
    public function buildFormatter(ContainerBuilder $container)
    {
        ...
        $this->loadHtmlFormatter($container);
        ...
        $definition = new Definition('Behat\Testwork\Output\Node\EventListener\ChainEventListener', array(
            array(
                new Definition('Behat\Behat\Output\Node\EventListener\AST\SuiteListener', array(
                    new Reference('output.node.printer.html.suite'),
    ...
    /**
     * Loads html formatter
     *
     * @param ContainerBuilder $container
     */
    protected function loadHtmlFormatter(ContainerBuilder $container){
        $definition = new Definition('Behat\Behat\Output\Printer\Formatter\HtmlFormatter');
        $container->setDefinition('output.node.printer.formatter.html_formatter', $definition);
 }
    ...
    {
        $definition = new Definition('Behat\Behat\Output\Node\Printer\Html\HtmlSuitePrinter', array(
            new Reference('output.node.printer.formatter.html_formatter')
        ));
        $container->setDefinition('output.node.printer.html.suite', $definition);
        ...
        $definition = new Definition('Behat\Behat\Output\Node\Printer\Html\HtmlPathPrinter', array(
            new Reference('output.node.printer.formatter.html_formatter'),
            '%paths.base%'
        ));
        $container->setDefinition('output.node.printer.html.path', $definition);

        $definition = new Definition('Behat\Behat\Output\Node\Printer\Html\HtmlScenarioPrinter', array(
            new Reference('output.node.printer.formatter.html_formatter'),
            new Reference('output.node.printer.html.path')
        ));
        ...
        $definition = new Definition('Behat\Behat\Output\Node\Printer\Html\HtmlStepPrinter', array(
            new Reference('output.node.printer.formatter.html_formatter'),
            new Reference('output.node.printer.html.step_text_painter'),
    ...
    {
        $definition = new Definition('Behat\Behat\Output\Node\Printer\Html\HtmlCounterPrinter', array(
            new Reference('output.node.printer.formatter.html_formatter'),
            new Reference(self::RESULT_TO_STRING_CONVERTER_ID),
            new Reference(TranslatorExtension::TRANSLATOR_ID)
        ));
        $container->setDefinition('output.node.printer.html.counter', $definition);

        $definition = new Definition('Behat\Behat\Output\Node\Printer\Html\HtmlListPrinter', array(
            new Reference('output.node.printer.formatter.html_formatter'),
            new Reference(self::RESULT_TO_STRING_CONVERTER_ID),
            new Reference(ExceptionExtension::PRESENTER_ID),
            new Reference(TranslatorExtension::TRANSLATOR_ID),
        ...
        $container->setDefinition('output.node.printer.html.list', $definition);

        $definition = new Definition('Behat\Behat\Output\Node\Printer\Html\HtmlStatisticsPrinter', array(
            new Reference('output.node.printer.formatter.html_formatter'),
            new Reference(self::RESULT_TO_STRING_CONVERTER_ID),
            new Reference('output.node.printer.html.counter'),
            new Reference('output.node.printer.html.list')
        ));
